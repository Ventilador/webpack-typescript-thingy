...
export function CollectExternalModuleReferences() {
    return function CollectExternalModuleReferences(this: IWaterfall<IRequestContext>, request: IRequestContext) {
